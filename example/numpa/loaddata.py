...
def download(ts_code) :
    ...
    for code in ts_code:
        ...
        diary.to_csv(f"/mnt/e/tushare/{code}diaryNone.csv",index=True,encoding='utf_8_sig')
        ...
        diary.loc[:, 'openinterest'] = 0
        diary = diary.sort_index()
        diary.to_csv(f"/mnt/e/tushare/{code}diaryqfq.csv",index=True,encoding='utf_8_sig')
        ...
        diary.loc[:, 'openinterest'] = 0
        diary = diary.sort_index()
        diary.to_csv(f"/mnt/e/tushare/{code}diaryhfq.csv",index=True,encoding='utf_8_sig')
